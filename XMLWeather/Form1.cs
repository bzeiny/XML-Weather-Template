...
namespace XMLWeather
{
    public partial class Form1 : Form
    {
        ...
        public static void ExtractForecast()
        {
            ...
            XmlReader reader = XmlReader.Create("http://api.openweathermap.org/data/2.5/forecast/daily?q=" +
                 city + "&mode=xml&units=metric&cnt=7&appid=3f2e224b815c0ed45524322e145149f0");
            ...
            while (reader.Read())
            {
                ...
                //TODO: if day object not null add to the days 
                days.Add(newDay);
            }
        }
